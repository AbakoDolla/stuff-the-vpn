'use client';
  ...
  import { Plus, RefreshCw, Trash2, ToggleLeft, ToggleRight, Server } from 'lucide-react';
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => setShowCreate(true)} className="btn-primary flex items-center gap-1.5"><Plus className="w-4 h-4" />Ajouter</button>
            </div>
          </div>
          ...
          <DataTable columns={cols} data={inbounds} loading={loading} searchable searchKeys={['remark','host','protocol']}
            ...
            actions={(i: Inbound) => (
              <div className="flex items-center gap-1">
                ...
                <button onClick={() => deleteInbound(i)} className="p-1.5 rounded-lg hover:bg-red-500/10 text-red-400"><Trash2 className="w-3.5 h-3.5" /></button>
              </div>
            )}
          />
