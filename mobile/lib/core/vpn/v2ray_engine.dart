...
/// Handles the actual Android VPN permission dialog and tunnel lifecycle.
library;
...
class V2RayEngine {
  ...
  /// Déclenche la vraie boîte de dialogue système Android
  ...
  Future<void> connect({
    ...
    if (!granted) {
      _statusController.add(const RealVpnStatus(
        ...
        errorMessage: "Permission VPN refusée",
      ));
      return;
    }
